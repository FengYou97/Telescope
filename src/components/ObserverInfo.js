  ...
  return (
    <div className="observer-info-container">
      ...
      <Checkbox
        ...
        style={{ margin: "10px", color: "rgb(54, 42, 88)" }}
        onChange={(e) => autoFillLocation(e.target.checked)}
      >
        Use Current Location
      </Checkbox>
      <Form {...layout} initialValues={initialValues} onFinish={onFormFinish}>
        <Form.Item
          label="Longitude"
          name="longitude"
          rules={[
        ...
        >
          <div className="label-text">
            ...
            <span className="hover-text">
              Observer's longitude (decimal degrees format)
            </span>
          </div>
          <InputNumber
            min={-180}
            ...
            onChange={(e) => onChangeHandler(e, "longitude")}
          />
          {true ? null : (
            <Checkbox disabled={true} style={{ marginLeft: "5px" }}></Checkbox>
          )}
        </Form.Item>
        ...
        >
          <div className="label-text">
            ...
            />
            <span className="hover-text">
              Observer's latitide (decimal degrees format)
            </span>
          </div>
          <InputNumber
            min={-90}
            ...
            onChange={(e) => onChangeHandler(e, "latitude")}
          />
          {true ? null : (
            <Checkbox disabled={true} style={{ marginLeft: "5px" }}></Checkbox>
          )}
        ...
        >
          <div className="label-text">
            ...
            <img
              ...
              width="15px"
            />
            <span className="hover-text">Observer's altitude (meters)</span>
          </div>
          <InputNumber
            min={-413}
            max={8850}
            style={{ width: "40%" }}
            value={initialValues.altitude}
            onChange={(e) => onChangeHandler(e, "altitude")}
          />
        </Form.Item>
        ...
        >
          <div className="label-text">
            ...
            <img
              ...
              width="15px"
            />
            <span className="hover-text">Search radius (0-90)</span>
          </div>
          <InputNumber
            min={0}
            max={90}
            ...
            onChange={(e) => onChangeHandler(e, "radius")}
          />
        </Form.Item>
